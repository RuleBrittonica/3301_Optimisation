...
for year in years:
    ...
    for i, row in year_data.iterrows():
        ...
        plt.scatter(coords[0], coords[1], s=cumulative_chargers * 10, alpha=0.7, color=color, edgecolor='none')

    plt.title(f'Cumulative EV Chargers Added by Year {year}')
